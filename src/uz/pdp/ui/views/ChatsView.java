...
//                fileService.saveMessages();
    ...
    public static void showChats(List<Chats> chatsOfUser) {
        ...
        for (Chats chat : chatsOfUser) {
            ...
            if (contact != null) {
                System.out.println(i++ + ". " + contact.getName() + " " + last + " ( " + messageService.countNotReadMessages(chat.getId(), secondUser.getId()) + " ) ");
            } else {
                System.out.println(i++ + ". " + secondUser + " " + last + " ( " + messageService.countNotReadMessages(chat.getId(), secondUser.getId()) + " ) ");
            }
        }
        System.out.println("==========================");
    }
